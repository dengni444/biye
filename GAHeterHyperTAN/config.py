...
def parse():
    ...
    p.add_argument('--use_adaptive', type=int, default=0, help='0: use original model, 1: use adaptive curvature and base point model')
    p.add_argument('--use_dynamic_base', type=int, default=1, help='0: use origin as base point, 1: use learned base points (only works when use_adaptive=1)')
