...
# print(g.nodes['user'].data['u_fe'])
# print(g.edges['friend'].data['f_fe'])
# print(g.edges['visit'].data['v_fe'])
# print(g.edges['class_same'].data['cl_fe'])
#
# print(g.nodes['user'].data['u_fe'].size())
# print(g.edges['friend'].data['f_fe'].size())
# print(g.edges['visit'].data['v_fe'].size())
# print(g.edges['class_same'].data['cl_fe'].size())